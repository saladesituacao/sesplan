...
<div id="main" class="container-fluid">
    ...
    <form action="incluir_arquivo.php" method="post" enctype="multipart/form-data" name="form1" id="form1">            
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <select id="cod_tipo_documento" name="cod_tipo_documento" class="form-control">
                    <option></option>
                    <?php                        
                        $q = pg_query("SELECT cod_tipo_documento, txt_tipo_documento FROM tb_ciclo_planejamento_tipo WHERE cod_ativo = 1 ORDER BY txt_tipo_documento");
        ...
        <div class="row">
            <?php
            $sql = "SELECT tb_ciclo_planejamento.*, txt_usuario, txt_tipo_documento FROM tb_ciclo_planejamento ";
            $sql .= " INNER JOIN tb_usuario ON tb_usuario.cod_usuario = tb_ciclo_planejamento.cod_usuario ";
            $sql .= " INNER JOIN tb_ciclo_planejamento_tipo ON tb_ciclo_planejamento_tipo.cod_tipo_documento = tb_ciclo_planejamento.cod_tipo_documento ";
