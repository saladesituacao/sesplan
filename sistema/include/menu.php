                    ...
                    <li class="dropdown">
                        ...
                        <?php if (permissao_acesso(24)) { ?>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo($_SESSION["txt_caminho_aplicacao"]); ?>/gerencia/relatorio/detalhado.php">DETALHADO</a></li>
                                <li><a href="<?php echo($_SESSION["txt_caminho_aplicacao"]); ?>/gerencia/relatorio/pendencia.php">PENDÊNCIAS</a></li>
