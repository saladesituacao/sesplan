...
<div class="row">
    <div class="form-group col-md-12">
        ...
        <select id="cod_objetivo_ppa" name="cod_objetivo_ppa" class="form-control" onchange="frm1.submit();">
            <option></option>
            <?php
                if($cod_objetivo != "") {
...
<div class="row">
    <div class="form-group col-md-12">
        <label for="exampleInputEmail1">Programa de Trabalho:</label>
        <select id="cod_programa_trabalho" name="cod_programa_trabalho" class="form-control">
            <option></option>
            <?php
                if($cod_objetivo_ppa != "") {
                    $condicao_programa_trabalho = " AND cod_objetivo_ppa = " .$cod_objetivo_ppa;
                } 
                $q = pg_query("SELECT cod_programa_trabalho, nr_programa_trabalho FROM tb_programa_trabalho WHERE cod_ativo = 1 ".$condicao_programa_trabalho." ORDER BY nr_programa_trabalho");
                while ($row = pg_fetch_array($q)) 
                { ?>
