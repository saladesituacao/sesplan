...
if (empty($verificado) && !empty($id)) {
    permissao_acesso_pagina(48);

    $q1 = pg_query("SELECT * FROM tb_perfil WHERE cod_perfil = '$id'");
	$rs1 = pg_fetch_array($q1);
	$cod_ativo = limpar_comparacao($rs1['cod_ativo']);
	$txt_perfil = $rs1['txt_perfil'];
	$txt_descricao = $rs1['txt_descricao'];
}
else {
    permissao_acesso_pagina(47);
...
<div id="main" class="container-fluid">
    <h3 class="page-header">Perfis de Usuários > Incluir</h3>
    <form id="frm1">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" id="txt_perfil" name="txt_perfil" value="<?=$txt_perfil?>" placeholder="Obrigatório">
            </div><!--form-group-->
        </div><!--row-->   
        <div class="row">
            <div class="form-group col-md-12">
